...
enum class ScreenElement {
    ...
    CLIENT_OR_ISSUER_ADDRESS_TITLE,
    ...
    DOCUMENT_CLIENT_OR_ISSUER_ADDRESS1,
    DOCUMENT_CLIENT_OR_ISSUER_ADDRESS2,
    DOCUMENT_CLIENT_OR_ISSUER_ZIP,
    DOCUMENT_CLIENT_OR_ISSUER_CITY,
