...
data class ClientOrIssuerState(
    ...
    var companyId1Label: TextFieldValue? = TextFieldValue(Strings.get(R.string.client_company_identification1)),
    var companyId1Number: TextFieldValue? = null,
    var companyId2Label: TextFieldValue? = TextFieldValue(Strings.get(R.string.client_company_identification2)),
    var companyId2Number: TextFieldValue? = null,
    var companyId3Label: TextFieldValue? = TextFieldValue(Strings.get(R.string.client_company_identification3)),
