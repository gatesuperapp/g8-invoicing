...
import com.a4a.g8invoicing.ui.screens.shared.filterClientsByQuery
    ...
    ScaffoldWithDimmedOverlay(
        ...
        Column(
            ...
            Box(
                ...
                val filteredClients = remember(uiState.clientsOrIssuerList, searchQuery.text) {
                    uiState.clientsOrIssuerList.filterClientsByQuery(searchQuery.text)
                }
                ...
                ClientOrIssuerListContent(
                    clientsOrIssuers = filteredClients,
