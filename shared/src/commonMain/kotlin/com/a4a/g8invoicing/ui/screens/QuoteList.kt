...
import com.a4a.g8invoicing.shared.resources.appbar_quotes
import com.a4a.g8invoicing.shared.resources.quote_advice_convert
...
fun QuoteList(
    ...
    onClickDelete: (List<QuoteState>) -> Unit,
    onClickDuplicate: (List<QuoteState>) -> Unit,
    onClickConvert: (List<QuoteState>) -> Unit,
    onClickNew: () -> Unit,
    ...
    val selectedItems = remember { mutableStateListOf<QuoteState>() }
    ...
    ScaffoldWithDimmedOverlay(
        ...
        topBar = {
            TopBar(
                title = stringResource(Res.string.appbar_quotes),
                navController = navController,
                onClickBackArrow = {
        ...
        Column(
            ...
            Box(
                ...
                val filteredDocuments = remember(documentsUiState.quoteStates, searchQuery.text) {
                    documentsUiState.quoteStates.filterByQuery(searchQuery.text)
                }
                ...
                Column {
                    ...
                    DocumentListContent(
                        ...
                        addDocumentToSelectedList = {
                            selectedItems.add(it as QuoteState)
                            selectedMode.value = true
                        },
                        removeDocumentFromSelectedList = {
                            selectedItems.remove(it as QuoteState)
                    ...
                    if (documentsUiState.quoteStates.size == 1 && !hasActiveQuery)
...
private fun DisplayBatHelperAdvice() {
    ...
    Column(
        ...
        AnimatedVisibility(
            ...
            Text(
                text = stringResource(Res.string.quote_advice_convert),
        ...
        AnimatedVisibility(
            ...
            Text(
                text = stringResource(Res.string.quote_advice_convert1),
                textAlign = TextAlign.Center
            )
        }
        ...
        AnimatedVisibility(
            ...
            Text(
                text = stringResource(Res.string.quote_advice_convert2),
                textAlign = TextAlign.Center
            )
        }
    }
...
private fun resetSelectedItems(
    selectedItems: MutableList<QuoteState>,
    selectedMode: MutableState<Boolean>,
    keyToResetCheckboxes: MutableState<Boolean>,
) {
    selectedItems.clear()
    selectedMode.value = false
    // Allow to "reset" the checkbox rememberValue to false inQuoteListItem when recomposing
